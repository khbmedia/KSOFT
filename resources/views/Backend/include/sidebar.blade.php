...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="{{route('dashboard')}}" class="brand-link p-0">
    <p class="brand-text font-weight-light text-center m-0"><img src="{{asset('frontend/image/logo.svg')}}" width="56%"></p>
  </a>
  <!-- Sidebar -->
  <div class="sidebar">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{route('createHistory')}}" class="nav-link">
                <i class="fas fa-plus nav-icon"></i>
                <p>Add History</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{route('listHistory')}}" class="nav-link">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{route('createDocument')}}" class="nav-link">
                <i class="fas fa-plus nav-icon"></i>
                <p>Add Document</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{route('listDocument')}}" class="nav-link">
                <i class="fas fa-list nav-icon"></i>
                <p>List</p>
              </a>
            </li>
