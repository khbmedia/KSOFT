...
Route::prefix('admin')->middleware('auth')->group(function(){
    ...
    Route::prefix('document')->group(function(){
        Route::get('/','Backend\DocumentController@index')->name('listDocument');
        Route::get('/create','Backend\DocumentController@create')->name('createDocument');
        Route::post('/store','Backend\DocumentController@store')->name('storeDocument');
        Route::get('/edit/{id}','Backend\DocumentController@edit')->name('editDocument');
        Route::get('/delete/{id}','Backend\DocumentController@destroy')->name('deleteDocument');
        Route::get('/search','Backend\DocumentController@show')->name('searchDocument');
        Route::post('/update/{id}','Backend\DocumentController@update')->name('updateDocument');
    });
    // Preference
...
// Blog
    ...
    Route::prefix('history')->group(function(){
        Route::get('/','Backend\HistoryController@index')->name('listHistory');
        Route::get('/create','Backend\HistoryController@create')->name('createHistory');
        Route::post('/store','Backend\HistoryController@store')->name('storeHistory');
        Route::get('/edit/{id}','Backend\HistoryController@edit')->name('editHistory');
        Route::get('/delete/{id}','Backend\HistoryController@destroy')->name('deleteHistory');
        Route::get('/search','Backend\HistoryController@show')->name('searchHistory');
        Route::get('blog_detail/{id}','Backend\HistoryController@latest_detail')->name('blogDetail');
        Route::post('/update/{id}','Backend\HistoryController@update')->name('updateHistory');
    });
    // QAndA
    Route::prefix('q_and_a')->group(function(){
        Route::get('/','Backend\QAndAController@index')->name('listQAndA');
        Route::get('/create','Backend\QAndAController@create')->name('createQAndA');
        Route::post('/store','Backend\QAndAController@store')->name('storeQAndA');
        Route::get('/edit/{id}','Backend\QAndAController@edit')->name('editQAndA');
        Route::get('/delete/{id}','Backend\QAndAController@destroy')->name('deleteQAndA');
        Route::get('/search','Backend\QAndAController@show')->name('searchQAndA');
        Route::get('blog_detail/{id}','Backend\QAndAController@latest_detail')->name('blogDetail');
        Route::post('/update/{id}','Backend\QAndAController@update')->name('updateQAndA');
    });
    // Tour
...
Route::get('/project_detail/{id}','HomeController@project_detail')->name('project_detail');
Route::get('/document/{id?}','HomeController@document')->name('document');
